...
instruments = {
    "CE": {"key": "NSE_FO|54796", "symbol": "NIFTY 23600 CE 13 APR 26"},
    "PE": {"key": "NSE_FO|54797", "symbol": "NIFTY 23600 PE 13 APR 26"}
}

print(f"=== BACKTEST: 9:20 STRADDLE (EXPIRY DAY ATM 23600) ===")
